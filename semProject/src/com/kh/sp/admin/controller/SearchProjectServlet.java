...
public class SearchProjectServlet extends HttpServlet {
	...
	System.out.println("서치 프로젝트 오시죠?");
	...
	int searchList = new AdminService().searchProjectListCount(text);
	...
	ArrayList<CheckProject> list = null;
		...
		list = new AdminService().searchProject(currentPage, limit, text);


	String page ="/views/admin/searchProject.jsp";
