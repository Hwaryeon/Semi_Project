...
@WebServlet("/invRankSelectAll.adm")
public class InvRankSelectAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public InvRankSelectAllServlet() {
        super();
    }
...
currentPage = 1;
		...
		for(int i=0; i<rankList.size(); i++){
			System.out.println(i+" : " + rankList.get(i));
		}
