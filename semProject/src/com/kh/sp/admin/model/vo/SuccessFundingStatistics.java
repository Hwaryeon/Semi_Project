...
public class SuccessFundingStatistics {
	...
	public SuccessFundingStatistics(Date term, int endCount, int successCount, int successRate, int type1SucessCount,
		...
		this.type1SucessCount = type1SucessCount;
	...
	public int getType1SucessCount() {
		return type1SucessCount;
	}



	public void setType1SucessCount(int type1SucessCount) {
		this.type1SucessCount = type1SucessCount;
	}
	...
	public String toString() {
		return "SuccessFundingStatistics [term=" + term + ", endCount=" + endCount + ", successCount=" + successCount
				+ ", successRate=" + successRate + ", type1SucessCount=" + type1SucessCount + ", type1SuccessRate="
