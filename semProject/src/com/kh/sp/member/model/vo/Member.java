...
public String toString() {
	return "Member [userId=" + userId + ", platformType=" + platformType + ", refreshToken=" + refreshToken + ", email="
			+ email + ", userPwd=" + userPwd + ", userName=" + userName + ", nickName=" + nickName + ", phone=" + phone
			+ ", investorGrade=" + investorGrade + ", investmentLimit=" + investmentLimit + ", businessLicenseNo="
			+ businessLicenseNo + ", corporateRegistrationNo=" + corporateRegistrationNo + ", corporateName="
			+ corporateName + ", address=" + address + ", userClass=" + userClass + ", enrollDate=" + enrollDate
			+ ", status=" + status + ", pwdStatus=" + pwdStatus + ", platformId=" + platformId + ", gradingStatus="
			+ gradingStatus + ", b_reason=" + b_reason + ", b_enrollDate=" + b_enrollDate + "]";
}
