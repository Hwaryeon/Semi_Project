	...
	<div>
				...
				<div id="box">
					<div id="sortBox">
						<select name="sort">
							...
							<option name="sortCondition" value="corporate_name">업체명순</option>
							<option name="sortCondition" value="user_name">이름순</option>
							<option name="sortCondition" value="nickname">별명순</option>
							<option name="sortCondition" value="enroll_date">등록일순</option>
						</select>
		...
		<% for(Member m : blackList){ %>
					<tr>
						...
						<input type="hidden" name="userClass" id="userClass" value="<%= m.getUserClass()%>">
