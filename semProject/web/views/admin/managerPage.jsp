...
<body>
						...
						<div class="row">
							...
							<div name="searchCondition" id="search" value="search"
								...
								<input type="text" class="form-control input-sm" maxlength="64"
									placeholder="Search" id="search1" name="searchValue"
									value="search" />
	...
	<form id="selectOne" action="<%=request.getContextPath()%>/selectOneMember.adm" method="post">
	
	<input type="hidden" id="userId2" name="userId2">
	<input type="hidden" id="userClass2" name="userClass2">
