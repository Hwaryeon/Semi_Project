					...
					<div class="box_guide" id="gstInvCer">
						...
						<ol class="list_guide">
							...
							<li>
								...
								<p class="txt_guide">오마이컴퍼니에서 24시간 내로 입력하신 정보를 확인합니다.</p>
						...
						<div class="box_accor">
							...
							<ul class="list_accor">
								...
								<li id="gstInvFaq24" class="tit_down"> <!-- 활성화 클래스 : down  -->
									<em class="tit_accor">오마이컴퍼니는 어떤 역할을 담당하나요?</em>
									<div class="cont_accor">
										<p>- 오마이컴퍼니는 금융위원회에 등록된 온라인소액투자중개업자입니다.<br /><br /></p>
...
<p>&nbsp;</p>
<p>- 이에 증권형 크라우드펀딩 제도는 투자자들이 선의의 피해를 입지 않도록 제도적으로 발행인당 및 연간 투자한도에 제한을 두고 있습니다. 오마이컴퍼니는 투자자들이 투자위험과 관련된 내용을 숙지하고, 신중하게 투자를 결정하시도록 안내해드립니다. 증권형 크라우드펀딩에 대한 투자는 고위험투자로, 「예금자보호법」에 따라 보호되지 않으며 투자원금의 손실이 발생할 수 있으므로 투자를 결정하실 때에는 신중을 기하여 주시기 바랍니다.</p>
<p>&nbsp;</p>
								    </div>
								</li>
...
<p>소득공제를 받기 위해서는 투자하신 벤처기업에 투자확인서 발급을 요청하신 후, 이를 원천징수의무자에게 소득공제서류로 제출하시면 됩니다.</p>
								...
								<li id="gstInvFaq39" class="tit_down"> <!-- 활성화 클래스 : down  -->
									...
									<div class="cont_accor">
										<p>- 오마이컴퍼니는 투자자의 투자와 관련하여 별도의 수수료를 받지 않습니다. 단, 투자금액을 실시간계좌이체하는 과정에서 PG사 결제수수료가 일부 발생하며, 투자금액별 수수료는 다음과 같습니다.</p>
<p>&nbsp;</p>
<table>
<tbody>
<tr>
...
<p>&nbsp;</p>
								...
								<li id="gstInvFaq41" class="tit_down"> <!-- 활성화 클래스 : down  -->
									...
									<div class="cont_accor">
										<p>- 네, 모바일로도 투자하실 수 있습니다. 모바일 인터넷 브라우저에서 오마이컴퍼니 접속하신 후&gt; 증권형 선택 &gt; 원하시는 프로젝트에 투자를 진행해주시면 됩니다.<br /><br /><strong>- 단, 모바일을 통해 투자를 진행하시기 위해서는 몇가지 준비사항이 필요합니다.</strong></p>
<p><strong>1.&lsquo;BankPay PG 앱&rsquo; 설치</strong><br /><strong>2. 투자금을 결제할 &lsquo;금융기관 계좌&rsquo;, 모바일에서 사용가능한 &lsquo;공인인증서&rsquo;, &lsquo;보안카드(또는 OTP)&rsquo;</strong></p>
								...
								<li id="gstInvFaq45" class="tit_down"> <!-- 활성화 클래스 : down  -->
									...
									<div class="cont_accor">
										<p>- 발행기업의 펀딩 페이지에 해당 기업을 소개하는 IR 자료와 각종 참고자료가 게재됩니다. 그밖에 발행기업의 홈페이지나 SNS를 통해서도 사업활동 현황을 살펴보실 수 있습니다. 또한 펀딩이 마감된&nbsp;이후에도 오마이컴퍼니 홈페이지에서 크라우드펀딩 성공기업이 매년 1회 공시하는 요약재무정보 및 결산서류를 확인하실 수 있습니다.</p>
								    </div>
								</li>
