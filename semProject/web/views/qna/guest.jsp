...
<%@ include file="/views/common/headBar.jsp" %>
	<div id="omcWrap" style="margin-top:87px;">
		...
		<div id="cMain" style="margin-bottom: 1600px;">
...
<p>- 프로젝트의 리워드가 한정수량이거나 Early bird Reward일 경우&nbsp;결제와 함께 참여가 확정되는 카드결제서비스를 제공하고 있습니다. &nbsp;</p>
								...
								<li id="gstRewFaq9" class="tit_down"> <!-- 활성화 클래스 : down  -->
									<em class="tit_accor">결제 시 신용(체크)카드정보를 입력하면 iCrowd에서 번호를 수집하나요?</em>
									<div class="cont_accor">
								...
								<li id="gstRewFaq10" class="tit_down"> <!-- 활성화 클래스 : down  -->
									...
									<div class="cont_accor">
										<p>- iCrowd 마이페이지 ▶ 지불정보 설정 페이지에서 지불정보(카드번호)를 변경할 수 있습니다.</p>
...
<p>- 카드결제의 경우 당일 결제 후 취소에는 즉시환불 되며 결제일 이후 취소할 경우 영업일 기준 3~5일이 소요될 수 있습니다. 카드와 계좌이체 결제의 경우 결제 계좌로 환불이 이뤄지며 가상계좌의 경우 iCrowd 가상잔고로 환불 금액이 입금됩니다. 가상잔고로 입금된 금액은 다른 프로젝트 참여 시 결제금으로 사용가능하며, 출금신청을 할 경우 회원 계좌로 환불 처리됩니다.</p>
...
<p>- 성공해야리워드(All or nothing) 방식의 프로젝트의 경우 모집에 실패할 경우 결제가 이뤄지지 않기 때문에 별도의 환불절차가 없습니다.</p>
								...
								<li id="gstRewFaq14" class="tit_down"> <!-- 활성화 클래스 : down  -->
									...
									<div class="cont_accor">
										<p>결제 시 결제창에 입력한 이메일로 iCrowd 결제내역정보가 전달되며 해당 영수증 출력도 가능합니다.</p>
								    </div>
								</li>
...
<p><br />- iCrowd에서는 기부금영수증 발급이 불가능합니다. </p>
								    </div>
								</li>
