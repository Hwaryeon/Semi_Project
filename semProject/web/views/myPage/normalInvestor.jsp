...
<body>
	...
	<div class="container">
	<h2 align="center">투자자 인증하기</h2>
	
	<hr><p>* 투자자 인증에 앞서 비상장기업 투자는 원금 손실의 가능성이 크니 투자 위험 안내를 반드시 확인하세요.</p>
	<div align="center">
    <button class="form-control btn btn-danger" data-toggle="modal" data-target="#myModal">투자위험고지 확인하기</button>
    </div>
    <hr>
	<h4 align="center">계좌실명인증</h4>
	<br>
	...
	<br>
	<label> 계좌주(투자자 이름) </label><br>
    <input type="text" class="input-sm" id="name" name="name" readonly>
	...
	<label style="color: red; font-style: italic;">생년월일은 숫자만 입력하실 수 있습니다.</label>
	</div>
	<div class="error-birthNum2">
	<label style="color: red; font-style: italic;">생년월일은 6자리입니다.</label>
	</div>
	</form>
    ...
    <hr>
    <p>* 투자 인증을 진행하기 위해서는 회원님의 투자자 정보가 실제 정보와 일치해야 합니다. 위의 공란을 빠짐없이 작성하여 계좌실명인증을 진행해 주시기 바랍니다.</p>
    <p>* 계좌주의 변경은 <a href="<%= request.getContextPath() %>/updateMember.jsp">개인정보수정</a> 메뉴를 통해 가능합니다.</p>
	</div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" align="center">투자 위험 주지 및 고지</h4>
        </div>
 ...
 <br>
 &nbsp;귀하는 투자대상인 금융투자상품은 자본시장법에 따른 “증권”에 해당하므로 원본손실의 위험성이 있으며, 청약증거금 등 투자한 자금의 원본을 회수할 없음에 따른 손실의 위험이 있음을 이해합니다. 또한 귀하가 예상하거나 기대하는 수익의 일부 또는 전부를 얻지 못할 수 있습니다.<br>
 &nbsp;귀하는 iCrowd의 홈페이지에 게재(정정)된 모집되는 증권의 발행조건, 발행인의 재무상태가 기재된 서류 및 사업계획서의 내용, 증권의 취득에 따른 투자위험요소 등을 충분히 확인하였으며, 청약의 주문 시 회사는 투자 위험의 고지 등에 관하여 별도로 정한 방법에 의하여 통지하는 내용에 대하여 확인합니다.<br>
 &nbsp;귀하는 금번에 발행되는 비상장 증권의 발행목적은 한국거래소의 상장에 있는 것은 아니므로 증권의 환금성에 큰 제약이 있음과 귀하가 예상하는 회수금액에 대한 일부 또는 전부를 회수할 수 없는 위험이 있음을 이해하며, 귀하가 이를 감당할 수 있음을 확인합니다.<br>
 &nbsp;귀하는 시장의 상황, 제도의 변경이 있을 수 있으며, 자본시장법 등 관련법규에 근거하여 투자의 한도에 제한이 있는 경우 이를 준수하여야 함을 이해합니다.<br>
 &nbsp;귀하는 자본시장법 제117조의10 제7항에 따라 전문투자자(벤처캐피탈 등)에 대한 매도 등 예외적인 경우를 제외하고는 원칙적으로 6개월간 전매가 제한된다는 점을 이해합니다.<br>
 &nbsp;귀하는 정부가 투자대상인 증권과 관련하여 게재된 사항이 진실 또는 정확하다는 것을 인정하거나 해당 증권의 가치를 보증 또는 승인한 것이 아니라는 점과 게재된 투자정보에 관한 사항은 청약기간 종료 전에 정정될 수 있음을 확인합니다.<br>
 &nbsp;귀하는 청약기간 중에만 한정하여 청약의 철회가 가능하며(청약기간 종료일 이후에는 청약의 철회 불가), 청약기간의 종료 시 모집금액이 발행인이 목표한 모집예정금액의 80% 미달하는 경우 증권의 발행은 취소된다는 점을 이해합니다.<br>
 <br>
 &nbsp;귀하는 아래 사항들에 대하여도 이해하였음을 확인합니다.<br>
 <br>
 &nbsp;iCrowd는 온라인소액증권 청약과 관련하여 별도의 수수료는 징수하지 않습니다.<br>
 &nbsp;발행인이 증권의 발행조건과 관련하여 조기상환조건을 설정한 경우 이에 대한 구체적인 내용을 홈페이지를 통해 반드시 확인하여야 합니다.<br>
 &nbsp;iCrowd는 자본시장법상의 온라인소액투자중개업자로서의 지위에서 온라인소액증권발행인과 온라인소액투자중개계약을 체결하여 위 발행인이 발행하는 증권에 대한 청약 거래를 중개하므로, 모집예정금액에 도달한다고 하더라도 직접 증권의 발행하거나 주금을 납입 받지 않습니다.<br>
 &nbsp;청약의 우대차별사유 : iCrowd는 발행인의 요청에 따라 합리적이고 명확한 기준(선착순 등)에 따라 투자자의 자격 등을 제한할 수 있습니다. 이 경우 귀하는 위 기준과 조건에 따라 청약거래에 있어 차별을 받게 될 수 있습니다.<br>
 <br>
